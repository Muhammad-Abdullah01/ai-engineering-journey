...
Documenting my transition from Data Science graduate to AI Engineer — one project at a time.
...
| 02 | [RAG Document Q&A](./02-rag-document-chat) | Embeddings, vector search, RAG pipeline, ChromaDB |
